...
#           ["Monday","Tuesday","Friday", "March"]
#           ["chicken","kitchen", "rabbit", "dog"]
#
...
#           ["chicken", "fish", "dog", "lion"]
#           fish should be the outlier but the result is lion
#           ["mom","dad","uncle","cousin"]
#           cousin should be the outlier but the result is mom
#
